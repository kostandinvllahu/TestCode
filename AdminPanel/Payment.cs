...
//textBox2.Text = (rdr["ID"].ToString());
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    total();
                    Con.Open();
                    string myquery = "UPDATE Client_tbl set Deposit='" + Total.Text + "'where IBAN='" + Iban.Text + "';";
        ...
        public void instructions()
        {
            ...
            {
                MessageBox.Show("Enter the ID card of the sender in the search box and press PRINT");
            }

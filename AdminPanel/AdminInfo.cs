       ...
       // DateTime today;
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Con.Open();
                SqlCommand cmd = new SqlCommand("insert into Admin_tbl values(" + ID.Text + ",'" + txtName.Text + "','" + txtPassword.Text + "','" +comboBox1.Text+"')", Con);
                cmd.ExecuteNonQuery();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
                ...
                Con.Open();
                string myquery = "UPDATE Admin_tbl set Username='" + txtName.Text + "',Password='" + password.Text +"', Position='"+comboBox1.Text+"'where Id=" + txtID.Text + ";";
        ...
        private void guna2Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                string Myquery = "select * from Admin_tbl where Id = '" + search.Text + "'";
                SqlDataAdapter da = new SqlDataAdapter(Myquery, Con);
                SqlCommandBuilder cbuilder = new SqlCommandBuilder(da);
                var ds = new DataSet();
                da.Fill(ds);
